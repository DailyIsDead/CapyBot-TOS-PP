...
11. Privacy Policy: If the Bot collects any user data, such data will be handled in accordance with the Bot Owner's Privacy Policy, which can be found at https://github.com/DailyIsDead/CapyBot-TOS-PP/blob/main/privacy-policy.md.
